...
import { createOrGetChat, getMyChats, getMessages, sendMessage, markMessagesAsRead, } from "../controller/chat.controller.js";
...
router.post("/message", authMiddleware, upload.single("file"), // image / audio / file
sendMessage);
